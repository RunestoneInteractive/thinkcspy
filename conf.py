...
setup.custom_js_files = ["https://media.ethicalads.io/media/client/ethicalads.min.js"]
...
project = "How to Think Like a Computer Scientist"
copyright = "2014 Brad Miller, David Ranum, Created using Runestone Interactive"
course_description = """(Outdated please use httlacs) Based on the original open source book by Allen B. Downey and Jeff Elkner. Learn Python, this edition is expanded with additional topics and is fully interactive.  Try examples, answer questions, interactively, right in the book!"""
...
exclude_patterns = [
    ...
    "OverviewForSite/*",
    "Appendices/app_*",
    "IntroRecursion/recursioncomplex*",
    "IntroRecursion/recursionexercises.rst",
    "IntroRecursion/thinkpyrecursion.rst",
...
latex_documents = [
    (
        "index",
        "ProblemSolvingwithAlgorithmsandDataStructures.tex",
...
man_pages = [
    (
        ...
        "Problem Solving with Algorithms and Data Structures Documentation",
        ["Brad Miller, David Ranum"],
        1,
    )
]
