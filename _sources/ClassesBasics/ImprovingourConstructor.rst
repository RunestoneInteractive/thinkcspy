...
We can make our class constructor more generally useful by putting extra parameters into the ``__init__`` method, as shown in this codelens example.
...
Now when we create new points, we supply the x and y coordinates as parameters. When the point is created, the values of ``init_x`` and ``init_y`` are assigned to the state of the object.
