...
.. container:: full_width
    ...
    Write a program that calculates the temperature based on how much the dial has been turned. You should prompt the user for a number of clicks-to-the-right. Then you should print the current temperature.
